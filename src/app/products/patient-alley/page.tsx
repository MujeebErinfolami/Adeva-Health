...
const FEATURES = [
  {
    title: "View validated, released results only",
    desc:  "Patients see results only after a qualified staff member has reviewed, validated, and authorised release.",
  },
  {
    title: "Result history and trend tracking",
    desc:  "Previous results are stored and displayed over time so patients can see how key values are changing.",
  },
  {
    title: "Downloadable formatted result reports",
    desc:  "Clean, formatted PDFs ready to share with any doctor, specialist, or insurer.",
  },
  {
    title: "Direct booking via referring doctor",
    desc:  "Referring clinics can send test requests directly into the system, reducing paperwork at the front desk.",
  },
];
...
export default function PatientAlleyPage() {
  return (
    <>
      <style>{`
        ...
        <section style={{ padding: "80px 24px" }}>
          <div style={{ maxWidth: "1160px", margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "20px", fontWeight: 500, color: C.shale, lineHeight: 1.3, marginBottom: "16px" }}>
              Secure result access for patients and referring doctors
            </p>
            <p style={{ fontSize: "16px", color: C.silver, maxWidth: "520px", lineHeight: 1.6, marginBottom: "40px" }}>
              Patient Alley gives patients a clean, secure portal to view their released results, track their history, and share reports with their doctor.
            </p>
            <a
